...
<html lang="es">
<head>
	<title>Consultar facturacion</title>
	<link rel="stylesheet" type="text/css" href="css/normalize.css">
	<link rel="stylesheet" type="text/css" href="css/consultarFacturacion.css">
...
<li class='active'><a href='#'>Facturacion</a>
	...
	<header>
     ...
     <form name="formulario" method="post" action="">
      <section id="eliminar">
      <p id="imprimir">No. de Cliente: <input type="text" placeholder="Numero de Cliente" name="validacion1" size="25"></p>
      
  <p id="btn"><input type="button" value="Imprimir Factura"onclick="consultar_factura()"></p>
